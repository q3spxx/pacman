var Char = {
	...
	enemiesInit: function (character) {
		...
		Pinky = new _Enemy(1, {x: 320, y: 288}, Anim.lib.pinky, 'inRoom')
		Pinky.__proto__ = aiPrototype
		Pinky.setDefault()

		Bob = new _Enemy(2, {x: 288, y: 288}, Anim.lib.bob, 'inRoom')
		Bob.__proto__ = aiPrototype
		Bob.setDefault()

		Paul = new _Enemy(3, {x: 352, y: 288}, Anim.lib.paul, 'inRoom')
